...
const services = [
  {
    ...
    description: "Generate, amend, or cancel E-Way Bills with structured compliance. Upload invoices and receive processed bills directly.",
    price: "₹40 per Bill",
  ...
  },
  {
    ...
    description: "Complete GST registration service as per Section 25 of the GST Act. PAN, Aadhaar, business constitution, and bank verification.",
    price: "₹5,000",
  ...
  },
  {
    ...
    description: "Monthly GSTR-1, 3B filing with ITC reconciliation, outward/inward supply management, and liability settlement.",
    price: "₹2,999/month",
  ...
  },
  {
    icon: BookOpen,
    title: "Bookkeeping",
    description: "Professional bookkeeping, ledger management, and accounts finalization tailored to your transaction volume.",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Select a service below to begin. Each service includes structured data collection, secure document upload, and professional processing by our team.
            </p>
          </div>
