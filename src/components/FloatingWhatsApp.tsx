...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 h-13 min-h-13 px-4 rounded-full bg-whatsapp text-primary-foreground flex items-center justify-center gap-2 shadow-lg hover:-translate-y-1 transition-transform"
    ...
    >
      ...
      <span className="hidden sm:inline text-sm font-semibold">Ask on WhatsApp</span>
    </a>
  );
};
